...
export declare abstract class UserRepository {
    ...
    abstract findById(id: string, editUser?: boolean): Promise<Partial<User> | null>;
    ...
    abstract SaveCheckoutInUser(items: CheckoutItems, user: Partial<User>, AdressItems: AdressItems): Promise<void>;
}
